...
resource "aws_lambda_function" "loading_lambda_handler_resource" {
  ...
  layers = [aws_lambda_layer_version.dependencies.arn, aws_lambda_layer_version.util_layer.arn, aws_lambda_layer_version.util_layer_2.arn, aws_lambda_layer_version.util_layer_3_load.arn, "arn:aws:lambda:eu-west-2:336392948345:layer:AWSSDKPandas-Python312:16"]
  depends_on = [
