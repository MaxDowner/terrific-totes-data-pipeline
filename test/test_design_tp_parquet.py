...
def test_design_to_parquet_returns_a_pq_file():
    # Arrange
    updated_rows = [
    {"design_id": 1, "design_name": "test_name", "file_location": "test_location", "file_name" : "test_file_name"}
    ]
...
def test_pq_file_is_readable():
    # Arrange
    updated_rows = [
    {"design_id": 1, "design_name": "data_2", "file_location": "data_3", "file_name" : "data_4"}, 
    {"design_id": 5, "design_name": "data_6", "file_location": "data_7", "file_name" : "data_8"}, 
    {"design_id": 9, "design_name": "data_10", "file_location": "data_11", "file_name" : "data_12"}
    ]
    if os.path.exists("/tmp/formatted_dim_design.parquet"):
        os.remove("/tmp/formatted_dim_design.parquet")
    design_to_parquet(updated_rows)
...
def test_design_to_parquet_func_writes_a_datum_correctly():
    ...
    expected = '[{"design_id":1,"design_name":"test_name","file_location":"test_location","file_name":"test_file_name"}]'
    # Act
    design_to_parquet(updated_rows)
...
def test_design_to_parquet_func_writes_multiple_data_correctly():
    ...
    expected = '[{"design_id":1,"design_name":"data_2","file_location":"data_3","file_name":"data_4"},{"design_id":5,"design_name":"data_6","file_location":"data_7","file_name":"data_8"},{"design_id":9,"design_name":"data_10","file_location":"data_11","file_name":"data_12"}]'
    # Act
    design_to_parquet(updated_rows)
    df = pd.read_parquet('/tmp/formatted_dim_design.parquet')
    df.to_json(json_check_file, orient='records')
