...
def test_runs_filename_from_timestamp_once(mocked_filename_from_timestamp, mocked_ingress):
    with mock_aws():
        mocked_ingress.return_value = [
                        {"currency":[1]},
                        {"staff":[2]},
...
def test_runs_get_s3_bucket_name_once(mocked_get_s3_bucket_name, mocked_ingress):
    with mock_aws():
        mocked_ingress.return_value = [
                        {"currency":[1]},
                        {"staff":[2]},
