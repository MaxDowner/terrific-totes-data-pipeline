...
<<<<<<< HEAD
        ...
        for result in results[3]["address"]:
            ...
            assert isinstance(result["address_line_2"], str | None)
            assert isinstance(result["district"], str | None)
...
<<<<<<< HEAD
        ...
        for result in results[4]["counterparty"]:
            ...
            assert isinstance(
                result["counterparty_legal_name"], str
            )
            assert isinstance(result["address_line_1"], str)
            assert isinstance(result["address_line_2"], str | None)
            assert isinstance(result["district"], str | None)
...
<<<<<<< HEAD
        ...
        for result in results[5]["sales_order"]:
            ...
            assert isinstance(result["design_id"], int)
            assert isinstance(
                result["agreed_delivery_date"], str
            )
            assert isinstance(
                result["agreed_payment_date"], str
            )
            assert isinstance(
